...
import 'package:app_sig2024/features/geolocalizacion/infrastructure/datasources/funcionesAyuda.dart';
...
class GeolocalizacionDatasourceImpl extends GeolocalizacionDatasource {
  ...
  Future<String> getRoutePuntosCorte(
    ...
    puntosCorte = FuncionesAyuda.filtrarPuntosCorteUtiles(puntosCorte);
    String travelMode = FuncionesAyuda.convertTravelMode(tipoTransporte);
    String routingPreference =
        FuncionesAyuda.convertRoutingPreference(nivelTrafico);
    String puntosIntermedios = FuncionesAyuda.puntosIntermedioBody(puntosCorte);
    String origen = '''
    "origin": {
        "location": {
            "latLng": {
